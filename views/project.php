...
<?php endif; ?>
			...
			<div id="main_body" class="flex">
				<img id="project_image" class="center project_image" src="<?php echo htmlentities(getProjectPicture($project_id, $db), ENT_QUOTES, 'utf-8'); ?>" alt="$project_id" width="100" height="100">
